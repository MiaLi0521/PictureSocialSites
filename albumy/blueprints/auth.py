...
from albumy.forms.auth import LoginForm, RegisterForm, ResetPasswordForm, ForgetPasswordForm
...
def forget_password():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('.forget-password'))
